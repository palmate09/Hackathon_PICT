...
# Load env deterministically from both project root and backend folder.
...
if _BACKEND_ENV.exists():
    # Backend .env should win in local dev to avoid stale/empty shell exports.
...
# Use explicit DATABASE_URL when provided. Otherwise use SQLite for local development.
DATABASE_URL = os.getenv('DATABASE_URL')
if not DATABASE_URL:
    os.makedirs(app.instance_path, exist_ok=True)
    sqlite_db_path = os.path.join(app.instance_path, 'portal.db')
