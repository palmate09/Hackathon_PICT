      ...
      <section className="profile-content">
        ...
        <div className="profile-completion-card">
          <div className="profile-completion-header">
            ...
            <span
              className={`profile-completion-percent ${
                completionPercentage >= 80 ? 'is-good' : completionPercentage >= 60 ? 'is-mid' : 'is-low'
              }`}
            >
          ...
          <p className="profile-completion-note">
            {completionPercentage < 60 && 'Complete at least 60% of your profile to apply for opportunities.'}
          ...
          <div className="profile-basic">
            <div className="profile-actions">
              <label className="btn btn-secondary">
                Upload Resume
                <input type="file" hidden accept=".pdf,.doc,.docx,.txt,.png,.jpg,.jpeg" onChange={uploadResume} />
              </label>
            ...
            <form className="profile-form" onSubmit={saveProfile}>
                ...
                {['first_name', 'middle_name', 'last_name'].map((field) => (
                  <div className="form-group" key={field}>
                    <label>
                      ...
                      {field !== 'middle_name' && <span className="required-mark"> *</span>}
                    </label>
                    <input 
              ...
              <div className="grid-3">
                ...
                <div className="form-group">
                  <label>Branch <span className="required-mark"> *</span></label>
                  <input
