      ...
      >
        ...
        >
          ...
          <div className="modal-body">
            ...
            <div className="profile-check modal-section">
            ...
            {/* Skill Match */}
            <div className="skill-match modal-section">
            ...
            {/* Resume Preview */}
            {resumePath && (
              <div className="resume-preview modal-section">
            ...
            {/* Cover Letter */}
            <form onSubmit={handleSubmit} className="application-form modal-section">
